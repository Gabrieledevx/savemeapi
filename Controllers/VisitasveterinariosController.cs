...
namespace savemeapi.Controllers
{
    ...
    [ApiController]
    public class VisitasveterinariosController : ControllerBase
    {
        private readonly SavemeContext _context;

        public VisitasveterinariosController(SavemeContext context)
        {
            _context = context;
        }

        // GET: api/Visitasveterinarios
        [HttpGet]
        ...
        // DELETE: api/Visitasveterinarios/5
        [HttpDelete("{id}")]
